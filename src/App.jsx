      ...
      <main className="relative mt-28">
        ...
        <section>
          <div className="container m-auto px-4 pt-12 pb-12 sm:pt-20 flex flex-col sm:flex-row gap-6 text-center sm:text-left">
            <div>
              <h2 className="font-bold text-4xl">Hello, I'm Abhiman,</h2>
              <div>
          ...
          <div className="container m-auto px-4 sm:py-12">
            ...
            <div className="flex flex-col sm:flex-row gap-10 mt-11">
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  Responsive HTML/CSS layout for online website for a
                  cyber-security committee. HTML5, CSS3 (SCSS), Javascript
                </p>
                <div className="flex mt-12 gap-2">
                  <a href="https://cyberhaiks.me" target="_blank">
              ...
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <p className="text-gray-400 text-sm mt-2">
                  Responsive HTML/CSS layout for online website for an Charity
            ...
            <div className="flex flex-col sm:flex-row  gap-10 mt-11">
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <h3 className="text-2xl font-semibold mt-8">
                  Landing page for Hair-Dresser Business
                </h3>
                <p className="text-gray-400 text-sm mt-2">
                  Responsive HTML/CSS layout for website of a Hair-Dresser
              ...
              <div className="border border-gray-500 rounded-md p-5 flex-1">
                ...
                <h3 className="text-2xl font-semibold mt-8">Web Raise</h3>
                <p className="text-gray-400 text-sm mt-2">
                  A BlockChain based Crowd Funding Dapp used to donate to
          ...
          <div className="container m-auto px-4">
            ...
            <div className="mt-12 relative before:absolute before:top-0 before:left-16 before:rounded-full before:bottom-10 sm:before:bottom-2 before:w-1 before:bg-white">
              <div className="pl-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                ...
                <p>
                  Started learning frontend Development after getting stuck in
                  lockdown, while in my 10th grade.
                </p>
              </div>
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2023</h3>
                <p>
                  Graduated from high school and joined college for a B.tech IT
                  degree.
                </p>
              </div>
              <div className="pl-24 mt-24 relative before:w-4 before:h-4 before:bg-gradient-to-t before:from-blue-500 before:to-cyan-500 before:absolute before:rounded-full before:left-[58px]">
                <h3 className="absolute left-0 text-lg font-semibold">2024</h3>
                <p>Learning and Growing while making interesting projects.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="container m-auto flex justify-between px-4 py-6">
          ...
          <div>
            <ul className="flex gap-4">
              ...
              <li>
                <a href="https://www.instagram.com/kroszborg" target="_blank">
